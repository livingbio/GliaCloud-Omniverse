...
// technique Mxao {
// 
//     pass p0 { VertexShader = MainVS; PixelShader = DepthInterleavePS; RenderTarget = ZSrc; }
//     pass p1 { VertexShader = MainVS; PixelShader = OcclusionWrap1PS;  RenderTarget = AOTexRaw; }
//     pass p2 { VertexShader = MainVS; PixelShader = OcclusionWrap2PS;  RenderTarget = AOTex1; }
//     pass p3 { VertexShader = MainVS; PixelShader = Filter1PS; RenderTarget = AOTex2; }
//     pass p4 { VertexShader = MainVS; PixelShader = Filter2PS; }
// 
//   /* pass {
